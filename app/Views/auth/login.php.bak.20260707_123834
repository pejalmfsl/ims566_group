        ...
        <div class="row min-vh-100 align-items-center justify-content-center py-4">
            <div class="col-12 col-md-8 col-lg-5">
                <div class="text-center text-white mb-4">
                    ...
                    <h1 class="h2 fw-bold mb-0">LERS Login</h1>
                </div>

                <div class="card shadow border-0 uitm-card">
                    <div class="card-body p-4 p-md-5">
                        <div class="text-center mb-4">
                            <h2 class="h4 mb-1 text-primary fw-bold">Log Masuk Sistem</h2>
                        ...
                        <?php if (isset($validation)): ?>
                            <div class="alert alert-danger" role="alert">
                                <div class="fw-semibold mb-1">Login tidak berjaya.</div>
                        ...
                        <div class="text-center mt-4">
                            <a href="<?= site_url('/') ?>" class="link-secondary text-decoration-none">Kembali ke landing page</a>
                        </div>
                    </div>
                </div>
            </div>
